/**
 * NEXUS Market Sénégal — Backend Node.js/Express v3.1.1
 * ======================================================
...
// ─── START ────────────────────────────────────────────────────────────────────
app.listen(PORT, () => {
  console.log(`\n🚀 NEXUS Market API v3.1.0 démarré sur le port ${PORT}`);
  console.log(`   Stripe   : ${process.env.STRIPE_SECRET_KEY ? '✅ configuré' : '⚠️  manquant'}`);
  console.log(`   Supabase : ${process.env.SUPABASE_URL ? '✅ configuré' : '⚠️  manquant'}`);
  console.log(`   Email    : ${process.env.SMTP_USER ? '✅ configuré' : '⚠️  manquant'}`);
