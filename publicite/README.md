# 📣 Publicité NEXUS Market — Kit réseaux sociaux

Dossier central pour **toutes les affiches promotionnelles** (Facebook, Instagram, WhatsApp, TikTok…).

- Les **fichiers exportés** (PNG/JPG depuis Canva) vont dans [`exports/`](./exports/).
- Ce README = **brief de design** + **légendes prêtes à copier‑coller** pour chaque fonctionnalité.
- Designs créés sur **Canva** (voir les liens dans [`canva-liens.md`](./canva-liens.md) une fois générés).

---

## 🎨 Charte graphique (à respecter sur chaque affiche)

| Élément | Valeur |
|---|---|
| Vert principal | `#00853E` |
| Jaune accent | `#FDEF42` |
| Rouge accent | `#E11B22` |
| Texte foncé | `#1F2937` |
| Police titres | Poppins / Montserrat (gras) |
| Police texte | Inter |
| Logo | « NEXUS Market » (badge NX) |
| Site | **nexusmarket.sn** |
| Page FB / Messenger | `m.me/nexusmarketsn` · `facebook.com/nexusmarketsn` |
| Ton | Local, fier, sénégalais 🇸🇳 — confiance, simplicité, proximité |

**Formats recommandés :**
- 📷 Post carré Instagram/Facebook : **1080 × 1080**
- 📱 Story / Statut WhatsApp : **1080 × 1920**
- 📘 Couverture Facebook : **1640 × 624**

---

## 🗂️ Les 12 affiches (1 par fonctionnalité)

### 1. 🛍️ La Marketplace
**Titre :** Tout le Sénégal dans une seule appli
**Sous‑titre :** Achetez & vendez en confiance · Paiement Wave, Orange Money & carte · Livraison partout
**Légende :**
...
### 2. 🛵 Coursier à la demande
**Titre :** Un coursier en quelques minutes
**Sous‑titre :** Livraison express à Dakar · Suivi GPS en direct
**Légende :**
...
### 3. 🔧 NEXUS Pro — Artisans & ouvriers
**Titre :** Un pro près de chez vous
**Sous‑titre :** Plombier, maçon, électricien, menuisier… trouvez et contactez un artisan vérifié
**Légende :**
...
### 4. 🐏 NEXUS Élevage & produits locaux
**Titre :** Moutons, bétail & produits du terroir
**Sous‑titre :** Spécial Tabaski 🐏 · Soutenez les éleveurs et producteurs sénégalais
**Légende :**
...
### 5. 🎬 NEXUS Stories
**Titre :** Les produits en vidéo
**Sous‑titre :** Découvre les vendeurs et leurs articles en stories
**Légende :**
...
### 6. 🔄 NEXUS Troc
**Titre :** Échangez sans argent
**Sous‑titre :** Troquez ce que vous n'utilisez plus contre ce dont vous avez besoin
**Légende :**
...
**Titre :** Gagne 5% en parrainant tes proches
**Sous‑titre :** Partage ton code, gagne une commission sur leurs achats
**Légende :**
...
### 8. ⭐ Fidélité & Points
**Titre :** Chaque achat te rapporte
**Sous‑titre :** Cumule des points, convertis‑les en réductions
**Légende :**
...
### 9. 🏪 Louma du vendredi
**Titre :** Le marché en ligne du vendredi
**Sous‑titre :** Ventes flash & promos exceptionnelles chaque vendredi
**Légende :**
...
### 10. 🏪 Devenez vendeur
**Titre :** Vends à tout le Sénégal
**Sous‑titre :** Ouvre ta boutique GRATUITEMENT · Validation sous 24h
**Légende :**
...
### 11. 🏢 Espace B2B (Acheteurs Pro)
**Titre :** Achats professionnels en gros
**Sous‑titre :** Devis, tarifs pro et facturation pour les entreprises
**Légende :**
...
### 12. 💳 Paiement sécurisé & Protection acheteur
**Titre :** Payez en toute sécurité
**Sous‑titre :** Wave · Orange Money · Carte · Argent versé au vendeur APRÈS réception
**Légende :**
...
|---|---|
| Lundi | Marketplace (#1) |
| Mardi | NEXUS Pro (#3) ou B2B (#11) |
| Mercredi | Stories (#5) / Troc (#6) |
| Jeudi | Ambassadeur (#7) / Fidélité (#8) |
| **Vendredi** | **Louma du vendredi (#9)** ⚡ |
...
- [ ] Légende + hashtags copiés depuis ce fichier
- [ ] Bon format selon le réseau (carré / story)
- [ ] Lien `m.me/nexusmarketsn` en bio pour le contact
